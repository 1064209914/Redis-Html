...
(function ($) {
    ...
    jconfirm.pluginDefaults = {
        template: '<div class="jconfirm"><div class="jconfirm-bg"></div><div class="container"><div class="row"><div class="col-md-12 col-md-offset-3 span6 offset3 set-area"><div class="jconfirm-box"><div class="closeIcon"><span class="glyphicon glyphicon-remove"></span></div><div class="title" style="border-bottom: 1px solid #e5e5e5;"></div><div class="content"></div><div class="buttons pull-right1"></div><div class="jquery-clear"></div></div></div></div></div></div>',
        title: 'Hello',
